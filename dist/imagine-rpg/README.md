...
Version 0.10.1. A conversion of the Imagine Role Playing System from its Roll20 character sheet,
...
**Version 0.10.1 and later update themselves.** In Foundry's **Game Systems** tab, press
...
One catch, once: an install from BEFORE 0.10.1 has no `download` in its manifest and cannot
